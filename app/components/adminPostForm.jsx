...
const AdminPostForm = ({ userId }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-4 bg-[#242422] rounded-lg">
     ...
     <button type="submit" disabled={isSubmitting} className="frelative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
